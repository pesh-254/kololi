    ...
    for (const participant of participants) {
        try {
            ...
            if (customMessage) {
                ...
                // Default message with WWE quote
                finalMessage = `@${displayName} has left the group.\n\nQuote: "The only one who can stop me is me" - John Cena`;
            }
