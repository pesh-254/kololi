...
global.author = settings?.author || "Dave Tech";
...
case userMessage === `${prefix}nitumie`:
case userMessage === `${prefix}help`:
case userMessage === `${prefix}tuma`:
case userMessage === `${prefix}ntumie`:
case userMessage === `${prefix}Ii`:
case userMessage === `${prefix}send`:
case userMessage === `${prefix}get`:
